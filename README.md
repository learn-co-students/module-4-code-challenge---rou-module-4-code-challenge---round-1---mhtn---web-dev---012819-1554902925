...
2. Render a list of books that show the book title and book img X
3. Clicking on a book in the Book List should add it to the Book Shelf X
4. Clicking on a book in the Book Shelf should remove it from the Book Shelf X
5. Add a controlled form that allows the user to add a book to the Book List (this should _NOT_ persist) X
6. BONUS: Each book can only be added to Book Shelf one time (Book Shelf should not have duplicate books) X
